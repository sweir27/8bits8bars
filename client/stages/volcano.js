...
const setupVolcanoStage = app => {
  ...
  background = setupTile(PIXI.loader.resources["images/VOLCANO-background.png"].texture, app);
  midground3 = setupTile(PIXI.loader.resources["images/VOLCANO-midground3.png"].texture, app);
  midground2 = setupTile(PIXI.loader.resources["images/VOLCANO-midground2.png"].texture, app);
